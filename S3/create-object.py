...
def main(s3Client):
    ...
    print(uploadObject(s3Client, bucket_name, source_file_name, contentType, {metaData_key: metaData_value}))
    
    print('\nEnd of create object script\n')

def uploadObject(s3Client, bucket, name, contentType, metadata={}):
