...
def main(s3Client):
    ...
    processed_file_name = config['object_name'] + config['processed_file_extension']
    ...
    csvStr = getCSVFile(s3Client, bucket_name, source_file_name)
...
def getCSVFile(s3Client, bucket, name):
...
def createObject(s3Client, bucket, name, data, contentType, metadata={}):
